    ...
    onSubmit={handleSubmit(submitContactForm)}>
      ...
      <div className='flex flex-col gap-5 lg:flex-row '>
        ...
        <div className='flex flex-col gap-2 lg:w-[48%]'>
          <label htmlFor='firstname' className='text-[14px] ml-1 text-richblack-5;'>
          First Name
          ...
          {
            errors.firstname && (
              <span className='mt-1 text=[12-px] text-yellow-100 '>
        ...
        {/* last name  */}
        <div className='flex flex-col gap-2 lg:w-[48%]'>
          <label htmlFor='lastname' className='text-[14px] ml-1 text-richblack-5;'>
          Last Name
      ...
      <label htmlFor='email' className='text-[14px] ml-1 text-richblack-5'>
        Email Address
      ...
      <div className='flex flex-col gap-2'>
        <label htmlFor="phonenumber" className='text-[14px] ml-1 text-richblack-5'>
          Phone Number
        </label>
